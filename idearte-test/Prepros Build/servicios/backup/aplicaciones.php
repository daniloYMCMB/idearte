...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Intro Header -->
    <header class="intro-servicios portada-aplicaciones content-section">
        <div class="servicios-body">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 col-md-offset-1 animated fadeInDownBig">
                        <h1 class="servicios-heading">Aplicaciónes Móviles</h1>
                        <p class="servicios-text">Desarrollo de aplicaciones en iOS y Android.</p>
